...
private:
    ...
    void _RegisterTransferLog(float Amount, clsBankClient DestinationClient, string UserName)
    {
        ...
        fstream MyFile;
        MyFile.open("TransfereRegister.txt", ios::out | ios::app);
    ...
    static stTransferRegisterRecord _ConvertTransferRegisterLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        TransferRegisterRecord.SourceAccountBalance = stof(TransferRegisterDataLine[4]);
        TransferRegisterRecord.DestinationAccountBalance = stof(TransferRegisterDataLine[5]);
...
public:
    ...
    static vector<stTransferRegisterRecord>GetTransferRegisterList() {
            ...
            fstream MyFile;
            MyFile.open("TransfereRegister.txt", ios::in);//read Mode
