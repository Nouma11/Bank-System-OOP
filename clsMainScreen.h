...
#include"clsTranscationScreen.h"
...
private:
    ...
    static short _ReadMainMenueOption()
    {
        ...
        short Choice = clsInputValidation::ReadNumberBetwen(1, 9, "Enter Number between 1 to 9? ");
        return Choice;
    }
    ...
    {
        clsTranscationScreen::ShowTransactionsMenue();

    }

    static void _ShowManageUsersMenue()
    {
        clsUserScreen::ShowManageUsersMenue();
